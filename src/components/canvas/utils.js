 ...
 */
export const setCanvasSize = function setCanvasSize (paper, w = null, h = null) {
  if (w && h) {
    paper.width = w;
    paper.height = h;
  } else {
...
export var fill = function fill (ctx) {
...
export var noFill = function noFill (ctx) {
  fill(ctx, 0, 0, 0, 0);
};
 ...
 */
export const paintBackground = function paintBackground (ctx, r = 0, g = 0, b = 0, a = 255, w = 500, h = 500) {
 ...
 **/
export var stroke = function stroke (ctx, r = 0, g = 0, b = 0, a = 255) {
  ctx.strokeStyle = 'rgba(' + r + ', ' + g + ', ' + b + ', ' + a + ')';
  ctx.beginPath();
  ctx.stroke();
};

export var noStroke = function noStroke (ctx) {
  stroke(ctx, 0, 0, 0, 0);
};

export var strokeWeight = function strokeWeight (ctx, weight) {
 ...
 * @return {void}
 */
export function drawLine (pen, pointA, pointB, color = '#000', lineWidth = 1) {
...
export var ellipse = function ellipse (ctx, v, rx) {
 ...
 */
export const arc = function arc (ctx, v, r, sa = 0, ea = Math.PI * 2) {
  ctx.beginPath();
...
export var drawPoly = function drawPoly (ctx, ps) {
  ctx.beginPath();
...
export var rect = function rect (ctx, pos, w, h) {
  ctx.beginPath();
 ...
 */
export const lerp = function lerpf (a, b, t) {
  return a + (b - a) * t;
};
 ...
 */
export const mapRange = function mapRange (value, u, v, x, y) {
  // return x + (y - x) * (value - u) / (v - u);
  return lerp(x, y, (value - u) / (v - u));
}

export function getValueFromRangeMapping (value, rangeA, rangeB) {
